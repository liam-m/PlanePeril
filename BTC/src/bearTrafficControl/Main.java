...
public class Main implements input.EventHandler {
	...
	private double dt;
	private java.util.Stack<screen.Scene> sceneStack;
	private screen.Scene currentScene;
	private classes.Score _score;
	...
	private void start() {
		...
		sceneStack = new java.util.Stack<screen.Scene>();
		setScene(new screen.Title(this));
		_score = new classes.Score();
	}
	 ...
	 * @param newScene
	 */
	public void setScene(screen.Scene newScene) {
