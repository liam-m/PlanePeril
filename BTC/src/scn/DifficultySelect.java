...
public class DifficultySelect extends Scene {
	...
	private final int sceneToCreate;
	// static ints for clarity of reading. Implement more to allow more game
	// scenes.
	 ...
	 * @param sceneToCreate
	 *            the scene to create after a difficulty has been selected, e.g.
	 *            Demo
	 */
	...
	public void start() {
		...
		textBox.newline();
		textBox.delay(1);
		textBox.addText("Guide planes to their destination successfully and you will be rewarded."
				+ TextBox.DELAY_START
				+ "0.5"
				+ TextBox.DELAY_END
				+ " Fail,"
				...
				+ "0.5"
				+ TextBox.DELAY_END
				+ " and the humans may discover your secret identity and put you in a zoo."
	...
	public void draw() {
		...
		graphics.rectangle(false, HARD_BUTTON_X, HARD_BUTTON_Y, HARD_BUTTON_W,
				HARD_BUTTON_H);
