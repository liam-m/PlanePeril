...
public class Demo extends Scene {
	...
	private libraryClasses.OrdersBox ordersBox;
	...
	private libraryClasses.ButtonText _manualOverrideButton;
	private classes.Altimeter altimeter;
	...
	@Override
	public void start() {
		ordersBox = new libraryClasses.OrdersBox(ORDERSBOX_X, ORDERSBOX_Y, ORDERSBOX_W, ORDERSBOX_H, 6);
		aircraftInAirspace = new java.util.ArrayList<Aircraft>();
		aircraftImage = graphics.newImage("gfx" + File.separator + "plane.png");
		libraryClasses.ButtonText.Action manual = new libraryClasses.ButtonText.Action() {
			@Override
			public void action() {
		...
		_manualOverrideButton = new libraryClasses.ButtonText("Take Control", manual, (window.width() - 128) / 2, 32, 128, 32, 8, 4);
		timeElapsed = 0;
		...
		_manualOverrideButton = new libraryClasses.ButtonText(" Take Control", manual, (window.width() - 128) / 2, 32, 128, 32, 8, 4);
		altimeter = new classes.Altimeter(ALTIMETER_X, ALTIMETER_Y, ALTIMETER_W, ALTIMETER_H);
		timeElapsed = 0;
		deselectAircraft();
