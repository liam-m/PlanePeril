...
public class DifficultySelect extends Scene {
	...
	public void start() {
		...
		ButtonText.Action easy = new ButtonText.Action() {
			...
			public void action() {
				...
				case DifficultySelect.CREATE_DEMO:
					main.setScene(new SinglePlayer(main, SinglePlayer.DIFFICULTY_EASY));
					break;
				}
			}
		};
		...
		buttons[0] = new ButtonText("Easy", easy, EASY_BUTTON_X, EASY_BUTTON_Y,
				EASY_BUTTON_W, EASY_BUTTON_H, true, true);
		...
		ButtonText.Action medium = new ButtonText.Action() {
			...
			public void action() {
				switch (scene_to_create) {
				case DifficultySelect.CREATE_DEMO:
					main.setScene(new SinglePlayer(main, SinglePlayer.DIFFICULTY_MEDIUM));
					break;
				}
			}
		};
		...
		buttons[1] = new lib.ButtonText("Medium", medium, MEDIUM_BUTTON_X,
				MEDIUM_BUTTON_Y, MEDIUM_BUTTON_W, MEDIUM_BUTTON_H, true, true);
		...
		ButtonText.Action hard = new ButtonText.Action() {
			...
			public void action() {
				switch (scene_to_create) {
				case DifficultySelect.CREATE_DEMO:
					main.setScene(new SinglePlayer(main, SinglePlayer.DIFFICULTY_HARD));
					break;
				}
			}
		};
